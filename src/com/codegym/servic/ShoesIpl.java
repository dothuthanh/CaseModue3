...
public class ShoesIpl implements IShoesService {
    private String jdbcURL = "jdbc:mysql://localhost:3306/productManager?allowPublicKeyRetrieval=true&useSSL=false";
    ...
    public List<Shoes> findAll() {
        ...
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_SHOES);) {System.out.println(preparedStatement);
    ...
    public List<Shoes> FindByCategoryShoes() {
            ...
            String selectAll = "SELECT *from productManager.shoes inner join CategoryShoes CS on shoes.shoes_id = CS.shose_id";
        ...
        public boolean delete(int shoes_id) throws SQLException {
            ...
            try (
                    Connection connection = getConnection();
                    PreparedStatement statement = connection.prepareStatement(DELETE_SHOES_SQL);
            ) {
